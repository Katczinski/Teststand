...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_3->addItem(verticalSpacer, 8, 0, 1, 2);
        ...
        gridLayout_3->addWidget(test, 9, 0, 1, 2);
