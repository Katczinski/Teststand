...
//    Reset();
    auto table  = new QTableWidget(4, 2, this);
...
//    main_layout->addWidget(buttons_label, Qt::AlignHCenter);
    main_layout->addLayout(buttons_layout, true);
...
void TestsCounter::Reset()
{
    ...
    table_items.result->setText("Тест исполняется");
    table_items.result->setForeground(QBrush(QColor("blue")));
